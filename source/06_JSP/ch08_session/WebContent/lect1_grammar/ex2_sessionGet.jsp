...
<body>
	<%
		...
		if(member!=null){
			out.println("<h2>member 안의 id : " + member.getId() + "</h2>");
			out.println("<h2>member 안의 pw : " + member.getPw() + "</h2>");
			out.println("<h2>member 안의 name : " + member.getName() + "</h2>");
		}
