...
<body>
		...
		<p>
			...
			<input type="text" name="name" id="name"
				   value='<%
							...
							if(schname!=null) out.print(schname);
				   		  %>'>
		</p>
		<p>
			전화 번호 
			<input type="text" name="tel" id="tel"
				   value='<%
				   			String schtel = request.getParameter("tel");
							if(schtel!=null) out.print(schtel);
				   		  %>'>
		</p>
		<p>
	...
	<table>
		...
		<%
			...
			ArrayList<FriendDto> fdto = dao.friendSchList(schname, schtel);
			if(fdto.isEmpty()) {
