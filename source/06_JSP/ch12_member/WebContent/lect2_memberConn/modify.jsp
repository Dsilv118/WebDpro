	...
	<form action="modifyOk.jsp" method="post">
		<table>
			...
			<tr>
				<th>새 비밀번호</th>
				<td>
					<input type="password" name="pw" placeholder="비밀번호 수정을 원하지 않으면 입력하지 마세요">
				</td>
			</tr>
			<tr>
				<th>새 비밀번호</th>
			...
			<tr>
				...
				<td>
					...
					<%-- Date 형의 경우 : birth.toString() "1995-12-12" --%>
					<%-- <input type="Timestamp" name="tempBirth" value='<%=birth==null ? "" : birth.toString().substring(0, 10) %>'> --%>
					<%-- Timestamp 형의 경우 : birth.toString() "1995-12-12 00:00:00" --%>
				</td>
			</tr>
			<tr>
				<th>주소</th>
