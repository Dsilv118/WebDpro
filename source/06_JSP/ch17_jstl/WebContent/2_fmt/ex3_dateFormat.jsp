...
<body>
	...
	<hr>
	<h4>날짜만 출력</h4>
	short sql date : <fmt:formatDate value="${nowDate }" type="date" dateStyle="short"/><br>
	short timestamp : <fmt:formatDate value="${nowTimes }" type="date" dateStyle="short"/><br>
	short util date : <fmt:formatDate value="${nowDateUtil }" type="date" dateStyle="short"/><br>
	...
	<fmt:formatDate value="${nowDate }" pattern="yyyy년 MM월 dd일(E요일) hh:mm:ss:SS"/><br>
