...
<body>
	<%!
		...
		String url    = "jdbc:mysql://127.0.0.1:3306/limdb?serverTimezone=UTC";
		String uid    = "root";
		String upw    = "mysql";
	%>
	<table>
			...
			try{
				...
				if(rs.next()){ // 데이터 있는 경우
					...
					do{
						...
						out.println("<tr><th>" + pno + "</th><th>" + pname + "</th><th>" + job + "</th>" +
										"<th>" + manager + "</th><th>" + startdate + "</th>" +
										"<th>" + pay + "</th><th>" + bonus + "</th><th>" + dno + "</th></tr>");
					}while(rs.next());
				}else{ // 데이터가 없는 경우
