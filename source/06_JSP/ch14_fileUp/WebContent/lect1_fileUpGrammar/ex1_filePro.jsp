...
<body>
	<%
		...
		try{
			...
			// new DefaultFileRenamePolicy() : 같은 이름의 파일이 있을 경우 : 1.jpg -> 11.jsp -> 12.jpg
		...
		try{
			...
			if(serverFile.exists()){
				...
				os = new FileOutputStream("D:/Dsilv/source/06_JSP/ch14_fileUp/WebContent/fileUpFolder/"+filename); // 소스폴더로 복사될 파일
				...
				System.out.println("서버에 업로드한 파일을 서버폴더로 복사 완료");
			}
		} catch(Exception e){
			System.out.println(e.getMessage());
		} finally {
