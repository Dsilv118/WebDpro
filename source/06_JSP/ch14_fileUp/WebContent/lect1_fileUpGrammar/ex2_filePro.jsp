	...
	<%
		...
		try{
			...
			while(paramNames.hasMoreElements()) {
				...
				oriFilenames[idx] = multiRequest.getFilesystemName(param); // 파라미터 이름으로 첨부한 오리지널 이름
				System.out.println(idx+"번째 파라미터 : "+param+", 서버 파일 이름 : "+filenames[idx]+", 오리지널 파일 이름 : "+oriFilenames[idx]);
				idx++;
			}
			...
			if(file!=null) {
				...
				try {
					...
					if(serverFile.exists()) { // file이 존재하면 복사
						...
						os = new FileOutputStream("D:/Dsilv/source/06_JSP/ch14_fileUp/WebContent/fileUpFolder/"+file);
