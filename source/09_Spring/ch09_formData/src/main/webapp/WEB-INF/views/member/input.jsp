...
<body>
	...
	<form action="${conPath }/member/join6" method="post">
		<table>
			...
			<tr><th>아이디</th><td><input type="id" name="id"></td></tr>
	...
	<a href="${conPath }/studentId/홍길도">홍길도로 전달</a>
	<a href="${conPath }/studentId/홍길순">홍길순로 전달</a>
	<a href="${conPath }/studentId/aaa">aaa로 전달</a>
</body>
</html>