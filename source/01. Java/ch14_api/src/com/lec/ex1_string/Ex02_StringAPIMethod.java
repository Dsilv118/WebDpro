...
public class Ex02_StringAPIMethod {
		public static void main(String[] args) {
			...
			System.out.println("10." + str4.indexOf('b', 6));             // 6번째 인덱스부터 나오는 첫 b   : 10. 9
			...
			System.out.println("16." + str3.trim());                      // 앞뒤 space 제거                    : 16. ja  va2
			System.out.println("17." + str4.replace("abc", "야"));         // "abc"를 "야"로 바꿈              : 17. 야X야X야X야
