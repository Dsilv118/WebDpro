...
public class Ex03_CardMain { // ♥, ♠, ◆,   ♣
	public static void main(String[] args) {
		Card[] cards = {new Card('♥', 2), new Card('♣', 3),
						new Card('♥', 7), new Card('♠', 5),
						new Card('♠', 4), new Card('♥', 6),
						new Card('♥', 1), new Card('♠', 12),
						new Card('♥', 10),new Card('♥', 13),
						new Card('♣', 5), new Card('◆', 8),
						new Card('◆', 6),  new Card('♥', 9),};
		for(Card card : cards) {
			System.out.println(card);
		}//for
		// 임의로 뽑힌 카드와 배열안에 카드를 비교 
