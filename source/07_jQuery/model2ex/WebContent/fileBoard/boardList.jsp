		...
		<table>
			<caption>
				...
				<c:if test="${not empty member}">
					<caption><input type="button" class="btn" value="글쓰기" onclick="location.href='${conPath }/boardWriteView.do'"></caption>
				</c:if>
			</caption>
		</table>
		<table>
				...
				<c:forEach var="dto" items="${list }">
					<tr>
						...
						<td class="left">
							...
							<%-- <a href="${conPath }/contentView.do?bid=${dto.bid}&pageNum=${pageNum}"> --%>${dto.ftitle }<!-- </a> -->
